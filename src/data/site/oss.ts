...
export const ossProjects: OssProject[] = [
  {
    ...
    slug: "csidh-wasm",
    description:
      "A WebAssembly port of the CSIDH isogeny cryptographic library, providing cryptographic primitives for post-quantum key exchange, allowing high-performance isogeny-based cryptography to run natively in web browsers, workers and Node.js environments.",
...
const bob_ss = lib.sharedKey(alice_pk, bob_sk);`,
  ...
  },
  {
    ...
    slug: "qubes-mat",
    description:
      "Secure, reproducible, and GitOps-driven metadata scrubbing infrastructure for Qubes OS. Automatically cleans metadata from images using MAT2 within disposable VMs, enforced by strict qrexec policies, and more.",
...
qrexec-client-vm work-vault my.CleanImage < /path/to/image.jpg`,
  ...
  },
  {
    ...
    description:
      "A multi-agent AI pipeline that transforms YouTube technical presentations into high-quality, structured Markdown articles.",
