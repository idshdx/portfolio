...
export const milestones: Milestone[] = [
  {
    ...
    description:
      'I stopped using my parent\'s work 386 computer when I was 12y old and got my first PC, was also one of the first in town to have an internet cable connection — a moment that sparked a lifelong passion for tinkering with computer hardware and software.',
